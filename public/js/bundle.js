...
var _animation = require('./components/animation.js');

var _animation2 = _interopRequireDefault(_animation);

var _indicator = require('./components/indicator.js');
...
console.log(box);
var box2 = document.getElementsByClassName('passion');
var firstshow = _gsap.TweenMax.staggerTo(box, 50, { opacity: 1 }, 20);
var second = _gsap.TweenMax.staggerTo(box2, 50, { opacity: 1 }, 20);
...
var scene = new _scrollmagic2.default.Scene({
	duration: 700,
	offset: 400
}).setTween(firstshow).addTo(controller);

var scene2 = new _scrollmagic2.default.Scene({
	duration: 1200,
	offset: 1000
}).setTween(second).addTo(controller);
...
},{"./components/animation.js":4,"./components/indicator.js":5,"gsap":1,"jquery":2,"scrollmagic":3}]},{},[6]);
